...
export const SellForm: React.FC<SellFormProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    logActivity(ACTIVITY_ACTIONS.FORM_SUBMIT, { form: 'sell', title: formData.title });
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {errors.photos && <p className="text-sm text-rose-gold font-poppins -mt-2">{errors.photos}</p>}

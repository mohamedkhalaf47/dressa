...
export const ActionsSection: React.FC<ActionsSectionProps> = ({
  ...
  const actions = [
    ...
    },
    {
      ...
      description: 'List your gently used dress and let someone else create memories',
      color: 'bg-rose-gold',
  ...
  return (
    <section id="actions" className="py-20 px-4 bg-gradient-to-b from-white to-soft-beige">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg font-poppins text-gray-600 max-w-2xl mx-auto">
            Choose how you'd like to be part of our sustainable fashion community
          </p>
        </div>
          ...
          {actions.map((action, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-600 font-poppins leading-relaxed">{action.description}</p>
              </div>
            );
          })}
        </div>
